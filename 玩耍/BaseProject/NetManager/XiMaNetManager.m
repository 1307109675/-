...
+ (id)getRankListWithPageId:(NSInteger)pageId completionHandle:(void (^)(RankingListModel *, NSError *))completionHandle
{
...
+ (id)getAlbumWithId:(NSInteger)ID page:(NSInteger)pageId completionHandle:(void (^)(AlbumModel *, NSError *))completionHandle
{
