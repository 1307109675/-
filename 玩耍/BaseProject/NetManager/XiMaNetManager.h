...
/*
 ...
 return   返回当前请求所在的任务
 */
+ (id)getRankListWithPageId:(NSInteger)pageId completionHandle:(void(^)(RankingListModel *model,NSError *error))completionHandle;
 ...
 *  @return 返回当前请求所在任务
 */
+ (id)getAlbumWithId:(NSInteger)ID page:(NSInteger)pageId completionHandle:(void(^)(AlbumModel *model,NSError *error))completionHandle;
@end
